        ...
        <div className=' mt-32  rounded-lg  bg-white shadow-md p-8 h-40  w-2/5'>
          <div className=' flex'>
            ...
            <form>
              ...
              <div class="relative ml-5">
                ...
                <input type="search" id="default-search" class="rounded-xl  block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300   focus:ring-blue-500 focus:border-blue-500 bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Whats Happening...." required />
              </div>
            </form>
          </div>
          <div className=' flex justify-between' >
            <span className=''>
              ...
              <button className='mt-10'>Live Video</button>
            </span>
            <span>
              <i class="ri-image-line mr-2"></i>
              <button className='mt-10'>Photos</button>
            </span>
            <span>
              <i class="ri-emotion-happy-line mr-2"></i>
              <button className='mt-10'>Feeling</button>
            </span>
            <span>
              {/* <button onClick={sentPost} className='mt-10 bg-pink-600 text-white p-2 rounded-lg' >POST</button> */}
              <button className='mt-10 bg-pink-600 text-white p-2 rounded-lg'> <Link href={'/PostSent'}>POST</Link></button>
            </span>
          </div>
        </div>
        <div className=''>
